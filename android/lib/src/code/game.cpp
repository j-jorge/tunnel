...
/**
 * \file
 * \brief Implementation of the tunnel::game class.
 * \author Julien Jorge
 */
#include "game.hpp"
 ...
 */
void tunnel::game::init_logger()
{
  claw::log_stream* const logger
    ( new claw::log_stream_uniq( new claw::android_logger( "TUNNEL" ) ) );
  ...
  const char* default_args[] =
    {
      ...
      "--tag=android",
      "--auto-load-symbols",
      "--stats-destination=http://www.stuff-o-matic.com/tunnel/stats/save.php",
