...
/**
 * \file
 * \brief Implementation of the tunnel::item_with_single_player_action_reader
 *        class.
 * \author Julien Jorge
 */
 ...
 */
template<class Base>
tunnel::item_with_single_player_action_reader<Base>::
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::on_enters_layer()
{
 ...
 */
template<class Base>
bool tunnel::item_with_single_player_action_reader<Base>::set_u_integer_field
...
template<class Base>
unsigned int
tunnel::item_with_single_player_action_reader<Base>::get_player_index() const
{
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::switch_action
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::clear_switched_action
(player_action::value_type a, player_action::value_type b)
{
  bool present(false);
  actions_map::const_iterator it;
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::start_action
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::do_action
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::stop_action
( player_action::value_type a )
{
  // nothing to do
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::set_player_index
( unsigned int i )
{
  m_player_index = i;
...
tunnel::item_with_single_player_action_reader<Base>::get_switched_action
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::update_action
(player_action::value_type a, player_action::value_type b,
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::read_input_action
 ...
 */
template<class Base>
void tunnel::item_with_single_player_action_reader<Base>::on_message
