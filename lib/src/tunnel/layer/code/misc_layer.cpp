...
/**
 * \file
 * \brief Implementation of the tunnel::misc_layer class.
 * \author Julien Jorge
 */
...
void tunnel::misc_layer::screenshot_file_save<ImageWriter>::operator()() const
{
  try
    {
 ...
 */
void tunnel::misc_layer::progress( bear::universe::time_type elapsed_time )
{
  ++m_its_count;
 ...
 */
void tunnel::misc_layer::render( scene_element_list& e ) const
{
  ++m_fps_count;
  render_fps( e );
} // misc_layer::render()
 ...
 */
bool tunnel::misc_layer::key_pressed( const bear::input::key_info& key )
{
  bool result = true;
 ...
 */
bool tunnel::misc_layer::mouse_move
 ...
 */
void tunnel::misc_layer::levelshot() const
{
 ...
 */
void tunnel::misc_layer::screenshot() const
{
  std::ostringstream name;
 ...
 */
template<typename ImageWriter>
void tunnel::misc_layer::screenshot( const std::string& name ) const
{
 ...
 */
void tunnel::misc_layer::sequence_screenshot()
{
 ...
 */
void tunnel::misc_layer::start_screenshot_sequence()
{
 ...
 */
void tunnel::misc_layer::stop_screenshot_sequence()
{
  const bear::engine::game& g( bear::engine::game::get_instance() );
 ...
 * \param e (out) The scene elements.
 */
void tunnel::misc_layer::render_fps( scene_element_list& e ) const
{
  if ( m_show_fps )
    {
