...
/**
 * \file
 * \brief Implementation of the tunnel::controller_map class.
 * \author Julien Jorge
 */
 ...
 */
template<typename T>
void tunnel::controller_map<T>::set
...
tunnel::controller_map<T>::find( value_type a ) const
{
 ...
 */
template<typename T>
void tunnel::controller_map<T>::set_key( bear::input::key_code key, value_type a )
{
  remove_key(key);
  remove_value(a);
  m_keyboard[key] = a;
 ...
 */
template<typename T>
typename tunnel::controller_map<T>::value_type
tunnel::controller_map<T>::find_key_value
 ...
 */
template<typename T>
bear::input::key_code tunnel::controller_map<T>::find_key( value_type a ) const
{
 ...
 */
template<typename T>
void tunnel::controller_map<T>::set_joystick
...
template<typename T>
typename tunnel::controller_map<T>::value_type
tunnel::controller_map<T>::find_joystick_value
...
tunnel::controller_map<T>::find_joystick( value_type a ) const
{
 ...
 */
template<typename T>
void tunnel::controller_map<T>::set_mouse
...
template<typename T>
typename tunnel::controller_map<T>::value_type
tunnel::controller_map<T>::find_mouse_value
...
tunnel::controller_map<T>::find_mouse( value_type a ) const
{
 ...
 */
template<typename T>
void tunnel::controller_map<T>::remove( const bear::input::controller_button& b )
{
  switch( b.get_type() )
    {
    case bear::input::controller_button::controller_keyboard:
 ...
 */
template<typename T>
void tunnel::controller_map<T>::remove_key( bear::input::key_code key )
{
 ...
 */
template<typename T>
void tunnel::controller_map<T>::remove_joy
...
template<typename T>
void
tunnel::controller_map<T>::remove_mouse( bear::input::mouse::mouse_code button )
{
 ...
 */
template<typename T>
void tunnel::controller_map<T>::clear()
{
  m_joystick.clear();
  m_keyboard.clear();
  m_mouse.clear();
 ...
 */
template<typename T>
bool tunnel::controller_map<T>::empty() const
{
 ...
 */
template<typename T>
void tunnel::controller_map<T>::remove_value( value_type a )
{
