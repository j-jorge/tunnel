...
/**
 * \file
 * \brief Implementation of the tunnel::player_pending_action class.
 ...
 * \brief Constructor.
 */
tunnel::player_pending_action::player_pending_action()
 ...
 * \brief Constructor.
 */
std::string tunnel::player_pending_action::to_string() const
{
