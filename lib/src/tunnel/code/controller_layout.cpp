...
/**
 * \file
 * \brief Implementation of the tunnel::controller_layout class.
 * \author Julien Jorge
 */
...
/*----------------------------------------------------------------------------*/
const std::string
tunnel::controller_layout::s_action_keyboard_section = "Action/Keyboard";
const std::string
tunnel::controller_layout::s_action_joystick_section = "Action/Joystick";
const std::string
tunnel::controller_layout::s_action_mouse_section = "Action/Mouse";
const std::string
tunnel::controller_layout::s_command_keyboard_section = "GUI/Keyboard";
const std::string
tunnel::controller_layout::s_command_joystick_section = "GUI/Joystick";
const std::string
tunnel::controller_layout::s_command_mouse_section = "GUI/Mouse";
...
tunnel::controller_layout::get_from_action( player_action::value_type a ) const
{
 ...
 */
bear::input::controller_button
tunnel::controller_layout::get_from_command( gui_command::value_type c ) const
{
 ...
 * \param a The action.
 */
void tunnel::controller_layout::set_action
 ...
 * \param c The command.
 */
void tunnel::controller_layout::set_command
 ...
 */
void tunnel::controller_layout::set_action_key
...
tunnel::controller_layout::get_action_from_key( bear::input::key_code key ) const
{
 ...
 */
bear::input::key_code
tunnel::controller_layout::get_key_from_action( player_action::value_type a ) const
{
 ...
 * \param a The action done with this key.
 */
void tunnel::controller_layout::set_action_joystick
 ...
 */
tunnel::player_action::value_type
tunnel::controller_layout::get_action_from_joystick
...
tunnel::controller_layout::get_joystick_from_action
( tunnel::player_action::value_type a ) const
{
 ...
 */
void tunnel::controller_layout::set_action_mouse
 ...
 */
tunnel::player_action::value_type
tunnel::controller_layout::get_action_from_mouse
...
tunnel::controller_layout::get_mouse_from_action
 ...
 */
void tunnel::controller_layout::set_command_key
...
tunnel::controller_layout::get_command_from_key( bear::input::key_code key ) const
{
 ...
 */
bear::input::key_code
tunnel::controller_layout::get_key_from_command( gui_command::value_type a ) const
{
 ...
 * \param a The command done with this key.
 */
void tunnel::controller_layout::set_command_joystick
 ...
 */
tunnel::gui_command::value_type
tunnel::controller_layout::get_command_from_joystick
  ( unsigned int joy, bear::input::joystick::joy_code key ) const
{
 ...
 */
bear::input::joystick_button
tunnel::controller_layout::get_joystick_from_command
( tunnel::gui_command::value_type a ) const
{
 ...
 */
void tunnel::controller_layout::set_command_mouse
 ...
 */
tunnel::gui_command::value_type
tunnel::controller_layout::get_command_from_mouse
  ( bear::input::mouse::mouse_code button ) const
{
 ...
 */
bear::input::mouse::mouse_code
tunnel::controller_layout::get_mouse_from_command
 ...
 */
void tunnel::controller_layout::escape_action_sequence
 ...
 */
void tunnel::controller_layout::load( std::istream& f )
{
 ...
 */
void tunnel::controller_layout::save( std::ostream& f ) const
{
  save_actions(f);
  save_commands(f);
 ...
 */
void tunnel::controller_layout::remove( const bear::input::controller_button& b )
{
  m_action.remove(b);
  m_command.remove(b);
 ...
 */
void tunnel::controller_layout::remove_key( bear::input::key_code key )
{
  m_action.remove_key(key);
  m_command.remove_key(key);
 ...
 */
void tunnel::controller_layout::remove_joy
( unsigned int joy, bear::input::joystick::joy_code key )
{
  m_action.remove_joy( joy, key );
  m_command.remove_joy( joy, key );
 ...
 */
void
tunnel::controller_layout::remove_mouse( bear::input::mouse::mouse_code button )
{
  m_action.remove_mouse(button);
  m_command.remove_mouse(button);
 ...
 */
bool tunnel::controller_layout::empty() const
{
 ...
 */
unsigned int tunnel::controller_layout::append_action_string
 ...
 */
bool tunnel::controller_layout::append_action_string
 ...
 * \param f The stream in which we write.
 */
void tunnel::controller_layout::save_actions( std::ostream& f ) const
{
 ...
 * \param f The stream in which we write.
 */
void tunnel::controller_layout::save_commands( std::ostream& f ) const
{
  claw::configuration_file config;
