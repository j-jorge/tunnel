...
void tunnel::player_proxy::apply_abort_teleport() const
{
  // Automatically generated. Do not edit this file.
  m_player->apply_abort_teleport();
}

void tunnel::player_proxy::apply_end_teleport() const
{
  // Automatically generated. Do not edit this file.
  m_player->apply_end_teleport();
}
