...
/**
 * \file
 * \brief Implementation of the tunnel::clingable class.
 * \author Sebastien Angibaud
 */
#include "tunnel/clingable.hpp"

#include "tunnel/player_proxy.hpp"

#include <algorithm>

BASE_ITEM_EXPORT( clingable, tunnel )
 ...
 */
void tunnel::clingable::progress( bear::universe::time_type elapsed_time )
{
 ...
 */
void tunnel::clingable::move( bear::universe::time_type elapsed_time )
{
 ...
 */
void tunnel::clingable::collision_check_and_apply
 ...
 * \param info Some informations about the collision.
 */
void tunnel::clingable::collision
( bear::engine::base_item& that, bear::universe::collision_info& info )
{
 ...
 */
void tunnel::clingable::get_dependent_items( std::list<physical_item*>& d ) const
{
