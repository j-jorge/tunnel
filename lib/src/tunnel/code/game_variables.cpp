 ...
 */
unsigned int ptb::game_variables::get_lives_count()
{
  return ptb_game_variables_get_value
 ...
 */
void ptb::game_variables::set_lives_count(unsigned int c )
{
  bear::engine::game::get_instance().set_game_variable
    ( bear::engine::variable<unsigned int>
 ...
 */
unsigned int ptb::game_variables::get_persistent_lives_count()
{
  return ptb_game_variables_get_value
