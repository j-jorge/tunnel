...
/**
 * \file
 * \brief Implementation of the tunnel::state_idle class.
 ...
 * \brief Constructor.
 */
tunnel::state_idle::state_idle( const player_proxy& player_instance )
 ...
 */
std::string tunnel::state_idle::get_name() const
{
  return "idle";
} // state_idle::get_name()
 ...
 */
void tunnel::state_idle::do_move_left()
{
  super::do_move_left();
 ...
 * \brief Move the player to the left.
 */
void tunnel::state_idle::do_move_right()
{
  super::do_move_right();
  m_player_instance.choose_walk_state();
 ...
 */
void tunnel::state_idle::do_look_upward()
{
 ...
 */
void tunnel::state_idle::do_continue_look_upward()
{
  m_player_instance.start_action_model("look_upward");
 ...
 */
void tunnel::state_idle::do_crouch()
{
 ...
 */
void tunnel::state_idle::do_continue_crouch()
{
  m_player_instance.start_action_model("crouch");
