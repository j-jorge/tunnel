...
/**
 * \file
 * \brief Implementation of the tunnel::state_cling class.
 ...
 * \brief Constructor.
 */
tunnel::state_cling::state_cling( const player_proxy& player_instance)
 ...
 */
std::string tunnel::state_cling::get_name() const
{
  return "cling";
 ...
 */
void tunnel::state_cling::do_slap()
{
 ...
 * \brief Do a jump.
 */
void tunnel::state_cling::do_jump()
{
 ...
 */
void tunnel::state_cling::do_move_left()
{
 ...
 * \brief Move the player to the left.
 */
void tunnel::state_cling::do_move_right()
{
  if ( m_player_instance.get_rendering_attributes().is_mirrored() )
    m_player_instance.set_want_clung_jump(true);
 ...
 */
void tunnel::state_cling::do_start_throw()
{
